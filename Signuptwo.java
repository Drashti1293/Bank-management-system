...
public class Signuptwo extends JFrame implements ActionListener {
    ...
    Signuptwo(String formno){
        ...
        setTitle("NEW ACCOUNT APPLICATION FROM-PAGE 2");
         ...
         String occupationValues[] = {"Job","Business","Student","Doctrate","Retired","Others"};
         ...
         JLabel existingaccout = new JLabel("Existing Account:");
         existingaccout.setFont(new Font ("Raleway", Font.BOLD, 20));
         existingaccout.setBounds(100, 590, 200, 30);
         add(existingaccout);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
                Conn c= new Conn();
                String query = "insert into signuptwo values('"+formno+"','"+sreligion+"','"+scategory+"','"+sincome+"','"+seducation+"','"+soccupation+"','"+span+"','"+sadhar+"','"+scitizen+"','"+sexistingaccount+"')";
